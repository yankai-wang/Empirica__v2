...
exports.SVGIconContainer = React.forwardRef(function (props, ref) {
    ...
    if (tagName === null) {
        ...
        return React.createElement(tagName, tslib_1.__assign(tslib_1.__assign({}, htmlProps), { "aria-hidden": title ? undefined : true, className: (0, classnames_1.default)(Classes.ICON, "".concat(Classes.ICON, "-").concat(iconName), className), ref: ref, title: htmlTitle }), React.createElement("svg", tslib_1.__assign({}, sharedSvgProps),
