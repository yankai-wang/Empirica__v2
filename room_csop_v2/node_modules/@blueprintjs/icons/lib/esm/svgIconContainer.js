...
export var SVGIconContainer = React.forwardRef(function (props, ref) {
    ...
    if (tagName === null) {
        ...
        return React.createElement(tagName, __assign(__assign({}, htmlProps), { "aria-hidden": title ? undefined : true, className: classNames(Classes.ICON, "".concat(Classes.ICON, "-").concat(iconName), className), ref: ref, title: htmlTitle }), React.createElement("svg", __assign({}, sharedSvgProps),
