...
exports.MenuItem = React.forwardRef(function (props, ref) {
    var _a, _b;
    var _c;
    var active = props.active, className = props.className, children = props.children, disabled = props.disabled, intent = props.intent, labelClassName = props.labelClassName, labelElement = props.labelElement, multiline = props.multiline, popoverProps = props.popoverProps, _d = props.roleStructure, roleStructure = _d === void 0 ? "menuitem" : _d, selected = props.selected, shouldDismissPopover = props.shouldDismissPopover, submenuProps = props.submenuProps, text = props.text, textClassName = props.textClassName, _e = props.tagName, tagName = _e === void 0 ? "a" : _e, htmlTitle = props.htmlTitle, htmlProps = tslib_1.__rest(props, ["active", "className", "children", "disabled", "intent", "labelClassName", "labelElement", "multiline", "popoverProps", "roleStructure", "selected", "shouldDismissPopover", "submenuProps", "text", "textClassName", "tagName", "htmlTitle"]);
    var _f = roleStructure === "listoption" // "listoption": parent has listbox role, or is a <select>
        ? [
            "option",
            undefined,
            (_c = props.icon) !== null && _c !== void 0 ? _c : (selected === undefined ? undefined : selected ? "small-tick" : "blank"),
            ...
            : roleStructure === "none" // "none": allows wrapping MenuItem in custom <li>
                ...
                : // roleStructure === "listitem"
                    [
                        ...
                        props.icon,
                        undefined, // don't set aria-selected prop
                    ], liRole = _f[0], targetRole = _f[1], icon = _f[2], ariaSelected = _f[3];
    ...
    var anchorClasses = (0, classnames_1.default)(common_1.Classes.MENU_ITEM, intentClass, (_a = {},
        ...
        _a[common_1.Classes.SELECTED] = active && intentClass === undefined,
        _a), className);
    ...
    var target = React.createElement(tagName, tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ 
        ...
        role: hasSubmenu ? "none" : targetRole, tabIndex: hasSubmenu ? -1 : 0 }, (0, props_1.removeNonHTMLProps)(htmlProps)), (disabled ? DISABLED_PROPS : {})), { className: anchorClasses }), hasIcon ? (
