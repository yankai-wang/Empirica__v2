  ...
  return (
    <div className="instructions" style={{ margin: "0 auto", width: "95%" }}>
      ...
      <p>
        ...
        <strong>assign students to dorm rooms</strong>. Students express their
        degree of satisfaction for living in a room as a number between 0 and
        100 (the higher the rating, the more satisfied the student is).{" "}
      </p>
      ...
      <div style={{ textAlign: "center" }}>
        <p>
          <strong>
            NOTE: ALL the students HAVE to be assigned to a room in order for
            your score to count.
          </strong>
        </p>
      </div>
